...
playAlert = setInterval(function() {
	...
	$.ajax({
		...
		success:function(data){
			...
			/* $.each(data, function(){  */
				...
				/* for(var i=0; i<2; i++){
					 table_count =+ data; 
					table_count.push(data);
					console.log(table_count+"<<ajax내부 for문 내부")
	...
	$.ajax({
		type:'GET',
		url:"${pageContext.request.contextPath}/today_total",
		dataType:"JSON",
		success:function(data){
			/* alert('성공'); */
			/* $.each(data, function(){  */
                ...
                <div class="panel">
                  <div class="panel-body">
                      <div class="col-md-6 col-sm-12">
                        <h3 class="animated fadeInLeft">오늘의 현황</h3>
                        <p class="animated fadeInDown"><span class="fa  fa-map-marker"></span>서울-강남</p>

                         <div class="col-md-6,content" style="width:100%;">
