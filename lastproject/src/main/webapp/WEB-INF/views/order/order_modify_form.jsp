	...
	$(document).ready(function(){
		...
		$('.addbutton').click(function(){
			...
			("<div class = '"+menu_id+"'><input name ='menu_id' id ='menu_id'"
					...
					+"<input name = 'order_detail_end_ea' id = 'order_detail_end_ea'"
					+"class = '"+menu_id+"' type = 'text' value = '0'  hidden = 'hidden' /> "
...
<form id="addform" action="${pageContext.request.contextPath}/order_modify_action" method="post">
		...
		<input name ="table_order_id" id ="table_order_id" type ="text" value="${order.table_order_id}" readonly="readonly"/ hidden = "hidden"></div>
		<input name ="table_order_num" id ="table_order_num" type ="text" value="${order.table_order_num}"readonly="readonly"/ hidden = "hidden"></div>
		<input name ="table_order_end" id ="table_order_end" type ="text" value="${order.table_order_end}"readonly="readonly"/ hidden = "hidden"></div>
		<input name ="table_order_date" id ="table_order_date" type ="text" value="${order.table_order_date}"readonly="readonly"/ hidden = "hidden"></div>
		<div id = "menu_frame"  style = "overflow:scroll; height : 200px;">	
